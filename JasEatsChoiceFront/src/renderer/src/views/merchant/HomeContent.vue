...
const dishData = {
  '早餐菜单': [
    { id: 1, name: '豆浆', price: 3, category: '饮品', status: 'online', stock: 100, updateTime: '2024-11-21 06:00' },
    { id: 2, name: '油条', price: 2, category: '主食', status: 'online', stock: 80, updateTime: '2024-11-21 06:30' },
    { id: 3, name: '包子', price: 1.5, category: '主食', status: 'online', stock: 120, updateTime: '2024-11-21 06:15' }
  ],
  '午餐菜单': [
    { id: 4, name: '鱼香肉丝', price: 18, category: '热菜', status: 'online', stock: 50, updateTime: '2024-11-21 10:30' },
    { id: 5, name: '宫保鸡丁', price: 16, category: '热菜', status: 'online', stock: 40, updateTime: '2024-11-21 10:45' },
    { id: 6, name: '西红柿鸡蛋', price: 12, category: '热菜', status: 'online', stock: 60, updateTime: '2024-11-21 10:20' }
  ],
  '晚餐菜单': [
    { id: 7, name: '红烧肉', price: 22, category: '热菜', status: 'online', stock: 30, updateTime: '2024-11-21 16:30' },
    { id: 8, name: '清蒸鱼', price: 28, category: '海鲜', status: 'online', stock: 20, updateTime: '2024-11-21 16:45' }
  ],
  '下午茶菜单': [
    { id: 9, name: '奶茶', price: 15, category: '饮品', status: 'online', stock: 70, updateTime: '2024-11-21 14:00' },
    { id: 10, name: '蛋糕', price: 25, category: '甜点', status: 'online', stock: 40, updateTime: '2024-11-21 14:30' }
  ],
  '今日特色菜单': [
    { id: 4, name: '鱼香肉丝', price: 18, category: '热菜', status: 'online', stock: 50, updateTime: '2024-11-21 10:30' },
    { id: 9, name: '奶茶', price: 15, category: '饮品', status: 'online', stock: 70, updateTime: '2024-11-21 14:00' }
...
const todayMenus = ref([
  ...
  },
  {
    id: 2,
    name: '晚餐菜单',
    dishes: dishData['晚餐菜单'].length,
    status: 'online',
    updateTime: '2024-11-21 14:00',
    autoOnline: '2024-11-22 17:00',
    autoOffline: '2024-11-22 21:00'
  },
  {
    id: 3,
    name: '早餐菜单',
    dishes: dishData['早餐菜单'].length,
    status: 'offline',
    updateTime: '2024-11-21 07:00',
    autoOnline: '2024-11-22 06:30',
    autoOffline: '2024-11-22 09:30'
  },
  {
    id: 4,
    name: '今日特色菜单',
    dishes: dishData['今日特色菜单'].length,
    status: 'online',
  ...
  },
  {
    id: 5,
    name: '下午茶菜单',
    dishes: dishData['下午茶菜单'].length,
    status: 'online',
    updateTime: '2024-11-21 13:00',
    autoOnline: '2024-11-22 14:00',
    autoOffline: '2024-11-22 16:00'
  }
]);
...
const filterMenus = (filterType, filterCategory = 'status') => {
  ...
  filteredMenus.value = todayMenus.value.filter(menu => {
    // 状态筛选
    const statusMatch = activeMenuFilter.value === 'all' ? true : menu.status === activeMenuFilter.value;
  ...
  if (selectedMenu.value && !filteredMenus.value.some(menu => menu.id === selectedMenu.value.id)) {
...
const toggleDishStatus = (dish) => {
  ...
  ElMessage.success(`菜品 ${dish.name} 已${dish.status === 'online' ? '上架' : '下架'}`);
  ...
  <div class="merchant-home-container" v-if="$route.path === '/merchant/home'">
    <div class="merchant-content">
        ...
        <div class="overview-grid">
          <div class="overview-item sales" @click="navigateToStatistics">
            ...
            <div class="item-content">
              ...
              <div class="overview-value">¥{{ businessOverview.sales.toFixed(0) }}</div>
          ...
          <div class="overview-item orders" @click="navigateToOrders">
            ...
            <div class="item-content">
              ...
              <div class="overview-value">{{ businessOverview.orders }}</div>
          ...
          <div class="overview-item comments" @click="navigateToComments">
            ...
            <div class="item-content">
              ...
              <div class="overview-value">{{ businessOverview.newComments }}</div>
          ...
          <div class="overview-item messages" @click="navigateToMessages">
            ...
            <div class="item-content">
              ...
              <div class="overview-value">{{ businessOverview.unreadMessages }}</div>
      ...
      <div class="quick-actions-card today-menu-card">
        ...
        <div class="menu-list">
          <div class="menu-item" v-for="menu in filteredMenus" :key="menu.id" :class="{ active: selectedMenu?.id === menu.id }" @click="switchMenu(menu)">
            <div class="menu-info">
              <div class="menu-name">
          ...
          <div class="dish-item" v-for="dish in currentMenuDishes" :key="dish.id">
            ...
            <div class="dish-info">
              ...
              <div class="dish-stats">
                ...
                <span class="dish-stock" :class="{'stock-almost': dish.status === 'almost_sold', 'stock-off': dish.status === 'offline'}">
                  {{ dish.status === 'almost_sold' ? '⏳ 即将售罄' : dish.status === 'offline' ? '❌ 已下架' : `📦 ${dish.stock} 份` }}
                </span>
              </div>
            </div>
            <div class="dish-actions">
              ...
              <el-button :type="dish.status === 'online' ? 'warning' : 'success'" size="small" @click="toggleDishStatus(dish)">
